...
<head>
    ...
    <script>
        var demoApp = angular.module('demoApp', [])
            .controller("InsertMHNDCtrl", ['$scope', function($scope) {
                $scope.success = false;
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-main">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quản lý câu hỏi <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Thêm câu hỏi</a>
                                        </li>
                                        <li><a href="#" id="CSCH">Sửa câu hỏi</a>
                                        </li>
                                                        ...
                                                        <form method="post" action="MonHocServlet" id="register-form" name="form" ng-submit="insert()" novalidate>
                                                            <div class="form-group">
                                                                ...
                                                                <div ng-show="form.mamh.$dirty && form.mamh.$invalid" class="text-danger">
                                                                    ...
                                                                    <span ng-show="form.mamh.$error.required">Bạn chưa nhập mã môn học</span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div ng-show="form.tenmh.$dirty && form.tenmh.$invalid" class="text-danger">
                                                                    ...
                                                                    <span ng-show="form.tenmh.$error.required">
                                                                        Bạn chưa nhập tên môn học</span>
                                                        ...
                                                        <form method="post" action="NoiDungThiServlet" id="register-form" name="form1" ng-submit="insert()" novalidate>
                                                            <div class="form-group">
                                                                ...
                                                                <div ng-show="form1.mand.$dirty && form1.mand.$invalid" class="text-danger">
                                                                    <i class="fa fa-times text-danger"></i>
                                                                    <span ng-show="form1.mand.$error.required">Bạn chưa nhập mã nội dung</span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div ng-show="form1.tennd.$dirty && form1.tennd.$invalid" class="text-danger">
                                                                    ...
                                                                    <span ng-show="form1.tennd.$error.required">
                                                                        Bạn chưa nhập tên nội dung</span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <i class="fa fa-check text-success" ng-show="form.mamh.$dirty && form.manh.$valid"></i>
                                                                <div ng-show="form.mamh.$dirty && form.manh.$invalid" class="text-danger">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form class="form-horizontal">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-4 control-label text-left">Mã môn học</label>
                                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-4 control-label text-left">Nội dung thi</label>
                                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <button type="button" class="btn btn-info">Xem câu hỏi</button>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading" role="tab" id="headingFour">
                                        ...
                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                                          4. Import ngân hàng câu hỏi</a></h4>
                                    </div>
                                                                ...
                                                                <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                                                                    <div class="modal-dialog modal-sm" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <a href="#" class="btn btn-success" id="btn-OK" role="button">OK</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
