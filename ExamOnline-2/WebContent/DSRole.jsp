    ...
    <script type="text/javascript">
          $(document).ready(function () {
               ...
               function check_roleid_ajax(roleid) {
                    $("#role-result").html('<img src="assets/Images/ajax-loader.gif" />');
                    $.post('CheckRole', {'roleid': roleid}, function (data) {
    ...
    <% 
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div id="main" ng-app="demoApp" ng-controller="InsertRoleCtrl">
                                    <form method="post" action="RoleServlet" id="register-form" name="form" ng-submit="register()" novalidate>
                                        <div class="form-group">
                                            <label for="inputRoleID">* Mã vai trò</label>
                                            <input name="roleid" id="inputRoleID" type="text" class="form-control" placeholder="" ng-model="roleid" autocomplete="off" required>
                                            <span id="role-result"></span>
                                            <!--Dấu check thể hiện việc nhập dữ liệu được nhập là hợp lệ-->
                                             <i class="fa fa-check text-success" ng-show="form.roleid.$dirty && form.roleid.$valid"></i>   
                                            <div ng-show="form.roleid.$dirty && form.roleid.$invalid" class="text-danger">
                                                <i class="fa fa-times text-danger"></i>
                                                <span>Bạn chưa nhập mã vai trò</span>

                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputRolename">* Tên vai trò</label>

                                            <input name="rolename" id="inputRolename" ng-model="rolename" type="text" class="form-control" placeholder="" required>
                                            <i class="fa fa-check text-success" ng-show="form.rolename.$dirty && form.rolename.$valid"></i>

                                            <div ng-show="form.rolename.$dirty && form.rolename.$invalid" class="text-danger">
                                                <i class="fa fa-times text-danger"></i>
                                                <span ng-show="form.rolename.$error.required" >
        ...
        <script>
            var demoApp = angular.module('demoApp', [])
                .controller("InsertRoleCtrl", ['$scope', function($scope) {
                    $scope.success = false;
