                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-main">
                      ...
                      <ul class="nav navbar-nav navbar-right">
                          <li data-toggle="tooltip" data-placement="top" title="Đăng xuất"><a href="Login.jsp" ><i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
                                ...
                                <ul class="clearfix">
                                    <div class="dropdown dropdown-vta">
                                        ...
                                        <a class="dropdown-toggle dropdown-vta-login" role="button" id="dropdownMenu1" data-toggle="dropdown">
                                            <% if(users !=null) { %>
                                            <span class="hello">Xin chào <span style="color:#EDB637;font-weight: bold"><%=users.getUserName()%></span></span>
                                                <%}%>
