...
<body class="fixed-left">
    <% 
        ...
        if(session.getAttribute("insertUsers")!=null) { 
            users=(Users) session.getAttribute("insertUsers"); 
        }
                        ...
                        <li class="nav-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow profile-dropdown " aria-labelledby="Preview">
                                ...
                                <div class="dropdown-item noti-title">
                                    <% if(users !=null){%>
                                <h5 class="text-overflow"><small>Xin chào <%=users.getUserName()%></small> </h5>
                                <%}%>
                            </div>

                            <!-- item-->
                            <% if(users !=null){%>
                            <a href="Profile.jsp?UserName=<%=users.getUserName()%>" class="dropdown-item notify-item">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div id="main" ng-app="demoApp" ng-controller="RegisterCtrl">
                                    <form method="post" action="UserServlet" id="register-form" name="form" ng-submit="register()" novalidate>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="username">* Tên đăng nhập</label>
                                                <input name="username" id="username" type="text" class="form-control" placeholder="Tên đăng nhập" ng-model="username" autocomplete="off" required>
                                                ...
                                                <div ng-show="form.username.$dirty && form.username.$invalid" class="text-danger">
                                                    ...
                                                    <span>Bạn chưa nhập tên tài khoản</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="password" id="form-input" ng-model="password" type="password" class="form-control" placeholder="Mật khẩu" ng-minlength="6" ng-maxlength="30" required>
                                                ...
                                                <div ng-show="form.password.$dirty && form.password.$invalid" class="text-danger">
                                                    ...
                                                    <span ng-show="form.password.$error.required" >
                                                        Mật khẩu không được bỏ trống</span>
                                                    <span ng-show="form.password.$error.minlength">
                                                        Mật khẩu phải dài hơn 6 kí tự</span>
                                                    <span ng-show="form.password.$error.maxlength">
                                                        Mật khẩu phải ngắn hơn 30 kí tự</span>
                                                </div>
                                            </div>               
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="fullname" id="form-input" type="text" class="form-control" placeholder="Tên người dùng" ng-model="fullname" autocomplete="off" required>
                                                ...
                                                <div ng-show="form.fullname.$dirty && form.fullname.$invalid" class="text-danger">
                                                    ...
                                                    <span ng-show="form.fullname.$error.required">Bạn chưa nhập tên người dùng</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputRole">* Vai trò</label>
                                                <select class="form-control input-sm" name="Role" id="form-input" ng-model="role" required>
                                                ...
                                                <div ng-show="form.role.$dirty && form.role.$invalid" class="text-danger"></div>
                                            </div>
                        ...
                        <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <sql:query var="items" sql="Select UserName, PASSWORD, FullName, NumberPhone, Email, RoleID  from users" />
                                                ...
                                                <c:forEach items="${items.rowsByIndex}" var="row">
                                                    <tr>
                                                        <c:forEach items="${row}" var="col">
                                                            ...
                                                            <td><a role="button" href="#edit?UserName=${col}">Sửa</a></td>
                                                       		<td><a role="button" href="#delete?UserName=${col}">Xóa</a></td>
                                                    </tr>
