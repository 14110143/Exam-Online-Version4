<%-- 
    Document   : DSTKNQTKyThi
    Created on : Oct 17, 2016, 9:24:58 AM
    Author     : Kelvin
--%>
                        ...
                        <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <sql:query var="items" sql="SELECT UserName, Password, FullName, Gender, Birthday, NumberPhone, Address, Email 
                               FROM users where RoleID='QLKT'" />
